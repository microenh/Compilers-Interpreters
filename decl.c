...
void do_const(SYMTAB_NODE_PTR const_idp)          /* constant id */
{
...
TYPE_STRUCT_PTR identifier_type(SYMTAB_NODE_PTR idp) /* type id */
{
...
TYPE_STRUCT_PTR make_string_typep(int length) /* string length */
{
