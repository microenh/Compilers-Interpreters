...
SYMTAB_NODE_PTR procedure_header(void)
{
  ...
  int             parm_count;
  int             total_parm_size;
  bool            forward_flag = false;   /* TRUE iff forwarded */
...
TYPE_STRUCT_PTR declared_routine_call(
  SYMTAB_NODE_PTR rtn_idp, /* routine id */
  bool parm_check_flag     /* if TRUE check parms */
)
{
...
void block(SYMTAB_NODE_PTR rtn_idp) /* id of program or routine */
{
